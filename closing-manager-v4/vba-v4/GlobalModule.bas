...
Dim Data
Sub CreatePaths()
'V4-CIO: one consistent working drive (CM_BASE_DRIVE, in mCloseEnv_V4), a local-path
'guard for OneDrive/SharePoint, and centralised folder creation. Callers keep using
'the same FPath / FTemp / Fmerger / ... globals exactly as before.
